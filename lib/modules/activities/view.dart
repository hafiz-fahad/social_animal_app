...
class _ActivitiesPageState extends State<ActivitiesPage> {
  final ActivitiesLogic logic = Get.put(ActivitiesLogic());
  final ActivitiesState state = Get.find<ActivitiesLogic>().state;
  @override
  Widget build(BuildContext context) {
    return GetBuilder<ActivitiesLogic>(
      builder: (_activitiesLogic) => GestureDetector(
        onTap: () {
